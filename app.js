...
let userInput = prompt(`Enter a number and letter`);
if(userInput >0 && userInput < 99999999999999999999999999999999999999999999999999999999999999999999n){
   document.write(`<br> ${userInput} is a number <br> <br> <hr>`)
}
else if(userInput > "a" && userInput < "z"){
   document.write(`<br> ${userInput} is a lower case letter <br> <br> <hr>`)
}
else if(userInput > "A" && userInput < "Z"){
   document.write(`<br> ${userInput} is a uppercase case letter <br> <br> <hr>`)
   }
   else{
...
let num1 = +prompt('Enter the 1st integers','10');
let num2 = +prompt('Enter the 2nd integers','20');
if(num1 > num2){
...
passwordArry.push(userPassword)

// console.log(passwordArry)

let userPassword1 =  prompt('Conform password')

if (passwordArry == userPassword1){
